...
def strip_encrypted_values():
	print "TODO: replace encrypted values with 'password'"

def shellify():
	print "TODO: Replace all steps with shell steps"

def remove_notification_schemes():
	print "TODO: remove custom notification schemes"

def show_usage():
	print "Usage: PrepAppImportJSON.py -f <File to check> [-s] [-R <name of output file>] [--OVERWRITE] [--VERBOSE]"
	print "\t-f flags for the input file"
	print "\t-s replace all steps with shell steps"
	print "\t-R File to write output to"
